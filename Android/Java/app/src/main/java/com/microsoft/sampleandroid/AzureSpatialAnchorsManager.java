...
class AzureSpatialAnchorsManager {
    ...
    public static final String SpatialAnchorsAccountId = "eb2ca4d8-b72e-4ed8-8d36-d641bf738d27";

    // Set this string to the account key provided for the Azure Spatial Service resource.
    public static final String SpatialAnchorsAccountKey = "G8lHbMiGJ/zZE7sosod1vToMGZRMYEPAePBElN4pVwc=";
